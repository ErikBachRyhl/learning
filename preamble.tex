...
\newtheorem{manualmexerciseinner}{Exercise}
...
\definecolor{tcplain}{HTML}{C83E4D} % Vibrant, deep poppy red for high contrast and eye-catching "pop"
% \definecolor{tcplain}{HTML}{3A6A92}
\definecolor{tcremark}{HTML}{FFFFFF}
\definecolor{tcdefn}{HTML}{66B2B2}
% 3A6A92
\definecolor{tcnote}{HTML}{FFFFFF}
\definecolor{tcexample}{HTML}{5F94BF}
...
\tcbset{
  myplain/.style={                    % For theorems, lemmas, propositions
    ...
    sharp corners,
    left=3mm,
    borderline west={3pt}{0pt}{tcplain!80}
  },
  myremark/.style={                   % For remarks and notes
    ...
    sharp corners,
    left=3mm,
    borderline west={3pt}{0pt}{tcremark!70}
  },
  mydefn/.style={                     % For definitions
    ...
    sharp corners,
    left=3mm,
    borderline west={3pt}{0pt}{tcdefn!80}
  },
  mynote/.style={                     % For personal notes
    ...
    sharp corners,
    left=3mm,
    borderline west={3pt}{0pt}{tcnote!70}
  },
  myexample/.style={                  % For examples and problems
    colback=tcexample!10,
    colframe=white,
    sharp corners,
    left=3mm,
    borderline west={3pt}{0pt}{tcexample!75}
  },
}
...
\tcolorboxenvironment{mexercise}{myexample}
